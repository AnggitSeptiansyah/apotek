...
export default function Drug({drugCategories}) {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={storeDrug} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                                <div>
                                ...
                                <div className='mt-4'>
                                    ...
                                    >
                                        ...
                                        {drugCategories.data.map(drugCategory => (
                                            <option value={drugCategory.id} key={drugCategory.id}>{drugCategory.name}</option>
                                        ))}
                                    </SelectInput>
                                    <InputError message={errors.price} className="mt-2" />
                                </div>
